...
import './WindowFrame.less';
 class WindowFrame extends Component {
  ...
  eventFN(e){
    ...
    switch (e.eventType) {
      case "Drag":
          ...
          // this.props.setWindowState(DragtWindowsObj)
          this.setStateValue(DragtWindowsObj,xs,ys)
          break;
      case "close":
          //如果是关闭事件
  ...
  setStateValue(windowsObj,xs,ys){
    //设置state中的值
    ...
    // this.refs.Window.style.transform="translate3d("+windowsObj.left+"px,"+windowsObj.top+"px, 0px)";
    // this.refs.Window.style.width=windowsObj.width+"px", 
    // this.refs.Window.style.height=windowsObj.height+"px",
    this.setState(o)
  }
  render() {
